...
public interface SignalsStorage {
	...
	public abstract void registerEodAlgorithmSerie(String executionName, SignalsSerie<StockSignal> serie);

	public abstract void addEodSignal(String executionName, Date date, StockSignal signal) throws BadSignalException;

	public abstract Signal<? extends StockSignal> getEodSignal(String executionName, Date date);

	public abstract Signal<? extends StockSignal> getEodSignal(String executionName, int index);
