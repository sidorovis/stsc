...
public class TestGeneticSimulatorSettings {
	...
	public static void fillFactory(SimulatorSettingsGeneticFactory settings, FromToPeriod period, final List<String> openTypes, double fStep, int nSide,
	...
	public static SimulatorSettingsGeneticList getGeneticList() {
		return getGeneticList(StockStorageMock.getStockStorage(), Arrays.asList(new String[] { "open", "high", "low", "close", "value" }), "31-12-2009");
	}

	public static SimulatorSettingsGeneticList getGeneticList(final StockStorage stockStorage, final List<String> openTypes, final String periodTo) {
		return getGeneticFactory(stockStorage, openTypes, periodTo).getList();
	}

	public static SimulatorSettingsGeneticFactory getGeneticFactory(final StockStorage stockStorage, final List<String> openTypes, final String periodTo) {
		try {
