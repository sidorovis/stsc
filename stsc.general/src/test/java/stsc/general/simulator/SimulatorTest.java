...
public class SimulatorTest extends TestCase {
	...
	// File("./test_data/simulator_tests/one_side.ini")).getStatistics().print("./test/statistics.csv");
	...
	// final EodExecution execution = new EodExecution("eName",
	// OneSideOpenAlgorithm.class, new AlgorithmSettingsImpl(period));
	// executionsStorage.addEodExecution(execution);
	//
	// final TradeProcessorInit tpi = new TradeProcessorInit(stockStorage,
	// period, executionsStorage);
	...
	// final FromToPeriod period = new FromToPeriod("01-09-2002", "27-09-2002");
	// final EodExecution execution = new EodExecution("eName",
	// OneSideOpenAlgorithm.class, new AlgorithmSettingsImpl(period).setString(
	// "side", "short"));
	// executionsStorage.addEodExecution(execution);
	//
	// final TradeProcessorInit tpi = new TradeProcessorInit(stockStorage,
	...
	// deleteFileIfExists("./test/statistics.csv");
	// Simulator.fromFile(new
	// File("./test_data/simulator_tests/simple.ini")).getStatistics().print("./test/statistics.csv");
	...
	// deleteFileIfExists("./test/statistics.csv");
	// Simulator.fromFile(new
	// File("./test_data/simulator_tests/ndays.ini")).getStatistics().print("./test/statistics.csv");
