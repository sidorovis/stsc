...
public class OrmliteFeedzillaDownloaderStatistics implements YahooDownloaderStatistics {
	...
	private OrmliteFeedzillaDownloaderStatistics() {
		// for ormlite
	}

	public OrmliteFeedzillaDownloaderStatistics(final String settingName) {
